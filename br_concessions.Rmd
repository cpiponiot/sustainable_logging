...
flextable(dftab, col_keys = c("omega0", "logIntensity", "logCycle", "Potential")) %>%
  ...
  set_header_labels(values = list(omega0 = "Comm. volume",
                                  ...
                                  logCycle = "Log. cycle",
                                  Potential = "Duration of maintained prod.")) %>%
